...
<body>
    <header>
        <div class="container">
            ...
            <nav>
                <ul>
                    <li><a href="#" data-target="list" class="active">펀드보기</a></li>
                    <li><a href="#" data-target="register">펀드등록</a></li>
                    ...
                    <?php endif ?>
                    <a href="/login.php">사이트 맵</a>
                    <a href="/login.php">도움말</a>
